...
template <class T, uint32 ROWS, uint32 COLS> inline const Matrix<T,ROWS,COLS> operator+(const Matrix<T,ROWS,COLS>& a) { return Matrix<T,ROWS,COLS>(+a.Unroll()); }
template <class T, uint32 ROWS, uint32 COLS> inline const Matrix<T,ROWS,COLS> operator-(const Matrix<T,ROWS,COLS>& a) { return Matrix<T,ROWS,COLS>(-a.Unroll()); }
...
template <class T, uint32 ROWS, uint32 COLS> inline const Matrix<T,ROWS,COLS> operator+(const Matrix<T,ROWS,COLS>& a, const Matrix<T,ROWS,COLS>& b) { return Matrix<T,ROWS,COLS>(a.Unroll() + b.Unroll()); }
template <class T, uint32 ROWS, uint32 COLS> inline const Matrix<T,ROWS,COLS> operator-(const Matrix<T,ROWS,COLS>& a, const Matrix<T,ROWS,COLS>& b) { return Matrix<T,ROWS,COLS>(a.Unroll() - b.Unroll()); }
template <class T, uint32 ROWS, uint32 COLS> inline const Matrix<T,ROWS,COLS> operator*(const T& a,               const Matrix<T,ROWS,COLS>& b) { return Matrix<T,ROWS,COLS>(a * b.Unroll()); }
template <class T, uint32 ROWS, uint32 COLS> inline const Matrix<T,ROWS,COLS> operator*(const Matrix<T,ROWS,COLS>& a, const T& b           ) { return Matrix<T,ROWS,COLS>(a.Unroll() * b); }
template <class T, uint32 ROWS, uint32 COLS> inline const Matrix<T,ROWS,COLS> mul(const Matrix<T,ROWS,COLS>& a      , const Matrix<T,ROWS,COLS>& b) { return Matrix<T,ROWS,COLS>(a.Unroll() * b.Unroll()); }
template <class T, uint32 ROWS, uint32 COLS> inline const Matrix<T,ROWS,COLS> div(const Matrix<T,ROWS,COLS>& a      , const Matrix<T,ROWS,COLS>& b) { return Matrix<T,ROWS,COLS>(a.Unroll() / b.Unroll()); }
template <class T, uint32 ROWS, uint32 COLS> inline const Matrix<T,ROWS,COLS> operator/(const Matrix<T,ROWS,COLS>& a, const T& b           ) { return Matrix<T,ROWS,COLS>(a.Unroll() / b); }

//template <class T, uint32 ROWS, uint32 COLS> inline const Matrix<T,ROWS,COLS> min(const Matrix<T,ROWS,COLS> a, const Matrix<T,ROWS,COLS> b) { return Matrix<T,ROWS,COLS>(min(a.Unroll(),b.Unroll())); }
//template <class T, uint32 ROWS, uint32 COLS> inline const Matrix<T,ROWS,COLS> max(const Matrix<T,ROWS,COLS> a, const Matrix<T,ROWS,COLS> b) { return Matrix<T,ROWS,COLS>(max(a.Unroll(),b.Unroll())); }

//////////////////////////
// Assignment Operators //
//////////////////////////

template <class T, uint32 ROWS, uint32 COLS> inline Matrix<T,ROWS,COLS>& operator+=(Matrix<T,ROWS,COLS>& a, const Matrix<T,ROWS,COLS>& b) { a.Unroll() += b.Unroll(); return a; }
template <class T, uint32 ROWS, uint32 COLS> inline Matrix<T,ROWS,COLS>& operator-=(Matrix<T,ROWS,COLS>& a, const Matrix<T,ROWS,COLS>& b) { a.Unroll() -= b.Unroll(); return a; }
template <class T, uint32 ROWS, uint32 COLS> inline Matrix<T,ROWS,COLS>& operator*=(Matrix<T,ROWS,COLS>& a, const T& b) { a.Unroll() *= b; return a; }
template <class T, uint32 ROWS, uint32 COLS> inline Matrix<T,ROWS,COLS>& operator/=(Matrix<T,ROWS,COLS>& a, const T& b) { a.Unroll() /= b; return a; }
...
template <class T, uint32 ROWS, uint32 COLS> inline const T reduce_add(const Matrix<T,ROWS,COLS>& a) { return reduce_add(a.Unroll()); }
template <class T, uint32 ROWS, uint32 COLS> inline const T reduce_mul(const Matrix<T,ROWS,COLS>& a) { return reduce_mul(a.Unroll()); }
template <class T, uint32 ROWS, uint32 COLS> inline const T reduce_min(const Matrix<T,ROWS,COLS>& a) { return reduce_min(a.Unroll()); }
template <class T, uint32 ROWS, uint32 COLS> inline const T reduce_max(const Matrix<T,ROWS,COLS>& a) { return reduce_max(a.Unroll()); }

//////////////////////////
// Comparison Operators //
//////////////////////////

template <class T, uint32 ROWS, uint32 COLS> inline bool operator ==(const Matrix<T,ROWS,COLS>& a, const Matrix<T,ROWS,COLS>& b) { return a.Unroll() == b.Unroll(); }
template <class T, uint32 ROWS, uint32 COLS> inline bool operator !=(const Matrix<T,ROWS,COLS>& a, const Matrix<T,ROWS,COLS>& b) { return a.Unroll() != b.Unroll(); }
template <class T, uint32 ROWS, uint32 COLS> inline bool operator  <(const Matrix<T,ROWS,COLS>& a, const Matrix<T,ROWS,COLS>& b) { return a.Unroll()  < b.Unroll(); }

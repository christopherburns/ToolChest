...
public:
   ...
   String PadToFieldWidth(uint32_t w) const;   ///< Adds trailing whitespace
...
inline String& String::operator += (const char * c)
{
   ...
   uint32_t newLength = (uint32_t)(strlen(_s) + strlen(c));
...
/// length
inline String String::PadToFieldWidth(uint32_t w) const
{
